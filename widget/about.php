...
class about_x extends WP_Widget
{
    ...
    function form($instance)
    {
        ...
        <p><label for="<?php echo $this->get_field_id('nnmber2'); ?>"><?php esc_attr_e('上传图片:'); ?>
                <input class="widefat" id="<?php echo $this->get_field_id('nnmber2'); ?>"
                       name="<?php echo $this->get_field_name('nnmber2'); ?>" type="text"
                       value="<?php echo $nnmber2; ?>"/>
        ...
        <p>
            ...
            <input class="widefat" name="<?php echo $this->get_field_name('showway'); ?>"
                   id="<?php echo $this->get_field_id('showway'); ?>" type="text" value="<?php echo $showway; ?>"/>
